...
class StreamByBitFuturesImplTest {
    ...
    fun checkOrderDeserialize() {
        ...
        val byBitMarketOrder = Mapper.asObject<exchange_api.bybit.websocket.messages.response.Order>(marketOrderMessage)
        val byBitLimitOrder = Mapper.asObject<exchange_api.bybit.websocket.messages.response.Order>(limitOrderMessage)

package exchange_api.bitmax.websocket

import com.neovisionaries.ws.client.*
import utils.mapper.Mapper.asObject
import utils.mapper.Mapper.asString
import exchange_api.bitmax.websocket.messages.requests.WebSocketAuth
import exchange_api.bitmax.websocket.messages.requests.WebSocketMsg
import exchange_api.bitmax.websocket.messages.responses.*
import mu.KotlinLogging

/**
 * Represents a Listener of webSocket channels
 */
class BitMaxApiWebSocketListener {
    /**
     ...
     */
    constructor(authMsg: WebSocketAuth, url: String, timeout: Int, keepConnection: Boolean = true, vararg subscribeMessages: WebSocketMsg) {

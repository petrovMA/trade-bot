...
import exchange_api.bybit.websocket.messages.response.Kline
...
data class Order(
    ...
    constructor(data: exchange_api.bybit.websocket.messages.response.Order.Data) : this(
...
data class Position(
    ...
    constructor(data: exchange_api.bybit.websocket.messages.response.Position.Data) : this(
    ...
    constructor(data: exchange_api.bybit.rest.response.PositionResponse.Result.Position) : this(
        pair = data.symbol.run { TradePair(take(3), drop(3)) },
        marketPrice = data.markPrice.toBigDecimal(),
        unrealisedPnl = data.unrealisedPnl.toBigDecimal(),
        realisedPnl = data.curRealisedPnl.toBigDecimal(),

...
interface ActiveOrdersService {
    ...
    fun getOrderByPriceAndSideBetween(botName: String, direction: DIRECTION, minPrice: BigDecimal, maxPrice: BigDecimal, side: SIDE): Iterable<ActiveOrder>
    fun getOrderByStopPriceAndSideBetween(botName: String, direction: DIRECTION, minStopPrice: BigDecimal, maxStopPrice: BigDecimal, side: SIDE): Iterable<ActiveOrder>
    ...
    fun saveAll(orders: Iterable<ActiveOrder>): Iterable<ActiveOrder>
    fun updateOrdersByOrderId(orders: List<ActiveOrder>): Iterable<ActiveOrder>
    fun updateOrdersById(orders: List<ActiveOrder>): Iterable<ActiveOrder>
}